        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetRoleName = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_CreatedByUserId_Status",
                table: "Tickets",
                columns: new[] { "CreatedByUserId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_TargetRoleName_Status",
                table: "Tickets",
                columns: new[] { "TargetRoleName", "Status" });
        }
